import { Checkbox, List, Number, Shape, TextInput } from '@makeswift/runtime/controls';

import DynamicProductContent from '~/components/amplience/dynamic-product-grid/dynamic-product-content';
...
runtime.registerComponent(DynamicProductGrid, {
...
runtime.registerComponent(DynamicProductContent, {
...
runtime.registerComponent(VideoShowcase, {
  type: 'video-showcase',
...
runtime.registerComponent(ContentCarousel, {
